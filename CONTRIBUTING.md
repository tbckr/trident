...
[code of conduct](https://github.com/tbckr/trident/blob/main/CODE_OF_CONDUCT.md).
...
`trident` is written in [Go](https://go.dev/).
...
Clone `trident` anywhere:

```sh
git clone git@github.com:tbckr/trident.git
```
...
Push your branch to your `trident` fork and open a pull request against the main branch.
