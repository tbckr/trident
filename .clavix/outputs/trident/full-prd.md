...
* **Env Variable Precedence:** Viper should prefer environment variables (e.g., TRIDENT_SHODAN_KEY) over config file values to allow secret injection in CI/CD without persisting files.
